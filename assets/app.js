...
const NEWSPAPERS_FALLBACK = [
  {id:'santuario-da-trindade',nome:'Jornal Santuário da Trindade',masthead:'assets/mastheads/santuario-da-trindade.webp',tipo:'Jornal',subtitulo:'Órgão do Santuário da Trindade',inicio:1922,fim:1931,edicoes:349,descricao:'Coleção digital completa já disponível, organizada por ano e edição, com pesquisa OCR no texto dos jornais.',status:'completo',url:'jornais/santuario-da-trindade.html'},
  {id:'brasil-central',nome:'Jornal Brasil Central',masthead:'assets/mastheads/brasil-central.webp',tipo:'Jornal',subtitulo:'Imprensa católica goiana',inicio:null,fim:null,edicoes:0,descricao:'Coleção em fase de catalogação e preparação documental.',status:'catalogando',url:'jornais/brasil-central.html'},
  {id:'santuario-dapparecida',nome:'Jornal Santuário d’Apparecida',masthead:'assets/mastheads/santuario-dapparecida.webp',tipo:'Jornal',subtitulo:'Grafia histórica preservada',inicio:null,fim:null,edicoes:0,descricao:'Coleção em fase de catalogação e preparação documental.',status:'catalogando',url:'jornais/santuario-dapparecida.html'},
  {id:'o-lidador',nome:'Jornal O Lidador',masthead:'assets/mastheads/o-lidador.webp',tipo:'Jornal',subtitulo:'Imprensa católica goiana',inicio:null,fim:null,edicoes:0,descricao:'Coleção em fase de catalogação e preparação documental.',status:'catalogando',url:'jornais/o-lidador.html'}
];
